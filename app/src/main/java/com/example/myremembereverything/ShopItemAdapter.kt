...
class ShopItemAdapter (var items:ArrayList<ShopItem>, var email:String) : RecyclerView.Adapter<ShopItemAdapter.ViewHolder>() { // 대형 쇼핑몰 정보 리사이클러뷰로 보여주기 위함
    ...
    override fun onBindViewHolder(holder: ShopItemAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        fun setItem(item:ShopItem) {
            ...
            itemView.shopaddress.text = item.address
